...
public class Home extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (clickedButton.getId() == R.id.submit_btn)
        {
            ...
            if (selectedAnswer.equals(Question.correctAnswer[currentIndex]))
            {
                score++;
            }
            currentIndex++;
    ...
    void loadNewQuestion()
    {
        ...
        questionBox.setText(Question.question[currentIndex]);
        ans1.setText(Question.options[currentIndex][0]);
        ans2.setText(Question.options[currentIndex][1]);
        ans3.setText(Question.options[currentIndex][2]);
        ans4.setText(Question.options[currentIndex][3]);
    }
    void finishQuiz()
    {
